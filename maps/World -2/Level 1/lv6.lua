...
local text = {
	{{"Don't fall. That's the bottomless pit.", 0, 0.01, blackcolor, smallFont, true, true, false, treyTalkSound, 'default'}}
}
...
newMap(16,16,'/graphics/tileset.png', tileString, quadInfo, text, entityText, entityBehaviorsFunction) --, background
