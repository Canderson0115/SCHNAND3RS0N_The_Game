...
local background = 'graphics/titleScreen.png'
...
newMap(16,16,'/graphics/tileset.png', tileString, quadInfo, text, entityText, entityBehaviorsFunction, scrollSpeed, background, 0, '8bitTiles') --, spawnText
