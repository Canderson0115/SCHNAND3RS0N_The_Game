...
local entityText = {
	['Joel'] = {
		['talk1'] = {"You're not supposed to be here. :I", 0, 0.0166, blackcolor, smallFont, true, true, false, joelTalkSound},
		['wasHitTalk1'] = {"The only reason you're still alive is that I don't have any fighting animations right now.", 0, 0.0166, purplecolor, smallFont, true, true, false, joelTalkSound},
		['sword1'] = {"Don't do this.", 0, 0.0166, redcolor, smallFont, true, true, false, joelTalkSound}
	}
}
