...
===========]                         llll         /
===========]                        lllll      &  /
===========] A AbBA  l       @  bB llllll   bB    /
============----------)     (----------------------
======================]     [======================
]]

local text = {
	{{"Yay, you beat the level, " .. map.player.name ..  "! Great job!>p >sToo bad there's no actual ending right now :I", 0, 0.0166, blackcolor, smallFont, true, true, false, mTalkSound, 'default'}}
}
