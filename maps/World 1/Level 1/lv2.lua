...
local text = {
	{{"Keep going, it's still after you!", 0, 0.005, blackcolor, smallFont, true, true, false, mTalkSound, 'surprised'}},
	{{"Try jumping off the edges while you're hanging on one to get over those boxes.", 0, 0.005, blackcolor, smallFont, true, true, false, mTalkSound, 'default'}}
}
