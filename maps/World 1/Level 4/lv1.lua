...
local entityText = {
	['Joel'] = {
		['talk1'] = {"Wassup dude.", 0, 0.0166, blackcolor, smallFont, true, true, false, joelTalkSound},
		['wasHitTalk1'] = {"You egg.", 0, 0.0166, blackcolor, smallFont, true, true, false, joelTalkSound},
		['sword1'] = {"Ow :(", 0, 0.0166, redcolor, smallFont, true, true, false, joelTalkSound}
	},
	['Trey'] = {
		['talk1'] = {"Hey, " .. map.player.name .. "!", 0, 0.0166, blackcolor, smallFont, true, true, false, treyTalkSound}
	},
	['Colton'] = {
		['talk1'] = {"Hi " .. map.player.name .. "! How's it going?", 0, 0.0166, blackcolor, smallFont, true, true, false}
	}
}
...
local quadInfo = { 
	...
	{ '2',  0 * tileWidth,  0 * tileWidth, false }, -- Pastry Boss; place air
	...
	{ '&',  0 * tileWidth,  0 * tileWidth, false }  -- end of level sign; place air
}
